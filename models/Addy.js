module.exports = (sequelize, DataTypes) => {
	...
	return sequelize.define('addys', 
	{
		...
		indx  		: 		{ type: DataTypes.STRING, allowNull: false },
		...
		balance 	: 		{ type: DataTypes.DOUBLE(11, 8), allowNull: true },
		prevAddy 	: 		{ type: DataTypes.INTEGER, allowNull: true, field: 'prev_addy'  },
		nextAddy 	: 		{ type: DataTypes.INTEGER, allowNull: true, field: 'next_addy'  },
